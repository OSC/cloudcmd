...
(function(CloudCmd, Util, DOM, CloudFunc) {
    ...
    function MenuProto(position) {
        ...
        // OSC_CUSTOM_CODE this is a custom version of getMenuData. The original is commented out below.
        function getMenuData(isAuth) {

            // OSC_CUSTOM_CODE getect whether current postion is null or not.
            var position = getCurrentPosition();
            var element  = DOM.getCurrentByPosition({
                x: position.x,
                y: position.y
            });
            ...
            isAuth(function(is) {
                var show        = function(name) {
                    ...
                    menu        = {
                        ...
                        'Download'      : download,
                        // OSC_CUSTOM_CODE disable "'Upload To Cloud': curry(uploadTo, 'Cloud')," because it's not working
